...
const recipes=[
  ...
  }, 
  {
    ...
    ingredients: [
      {name: "Onions (small)", quantity: 2},
      {name: "Potatoes (medium)", quantity: 6},
  ...
  }, 
  {
    ...
    ingredients: [
      ...
      {name: "Thai basil", quantity: 10},
      {name: "Cilantro", quantity: 10},
      {name: "Mint", quantity: 10},
      {name: "Tofu", quantity: 200},
      {name: "Bell pepper", quantity: 1},
      {name: "Green onions", quantity: 3},
      {name: "Lettuce", quantity: 0.5},
      {name: "Peanuts", quantity: 60},
      {name: "Rice wrappers", quantity: 10},
      {name: "Sesame seeds", quantity: 60},
      {name: "Peanut/satay sauce", quantity: 200},
      {name: "Vegetable Oil", quantity: 1},
      {name: "Salt", quantity: 1},
      {name: "Pepper", quantity:1 },
    ], 
    duration: 40, 
    image: "public/images/recipe4.jpg", 
  ...
  }, 
  {
    ...
    ingredients: [
      ...
      {name: "Ginger slice", quantity: 1},
      {name: "Chili", quantity: 1},
      {name: "Red bell pepper", quantity: 1},
      {name: "Yellow bell pepper", quantity: 1},
      {name: "Tomatos (medium)", quantity: 5},
      {name: "Spicy paprika powder", quantity: 1},
      {name: "Ground cumin", quantity: 1},
      {name: "Canned tomatoes, whole and peeled", quantity: 800},
      {name: "Vegetable broth", quantity: 50},
      {name: "Worcestershire sauce", quantity: 1},
      {name: "Eggs", quantity: 4},
      {name: "Feta", quantity: 50},
      {name: "Vegetable Oil", quantity: 1},
  ...
  }, 
  {
    ...
    ingredients: [
      {name: "Almond drink", quantity: 200},
      {name: "Coconut flour", quantity: 2},
      {name: "Wholemeal flour", quantity: 7},
      {name: "Agave nectar", quantity: 1},
      {name: "Puffed amaranth", quantity: 3},
      {name: "Baking powder", quantity: 3},
